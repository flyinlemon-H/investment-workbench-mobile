...
Local source commit: `414aae0`. The version commit updates only cache/version bindings, the release manifest generator description, its existing release assertion, and this release note. Product source remains the validated source commit.

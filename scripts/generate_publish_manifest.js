...
roleByPath.set('src/batch-technical-review.js','M05A batch technical review runtime');
roleByPath.set('src/multi-stock-analysis.js','M05A multi-stock analysis runtime');
...
const manifest={
  manifestVersion:1,
  sourceCommit,
  assetVersion:'m05a-workbench-mobile-20260814',

...
function v13CurrentActivePlanSummaryPanel(stock){
  ...
  const row=plan=>{
    if(PlanV2.hasWatchDefinition(plan)&&window.StateWatchWorkflow)return window.StateWatchWorkflow.card(plan,stock.id);

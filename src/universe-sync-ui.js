(function(root){
  ...
  root.openUniverseSyncSettings=()=>{const modal=dialog();modal.querySelectorAll('[name=analysisSyncRole]').forEach(input=>input.checked=input.value===root.ManualAnalysisSyncCloud.role());modal.classList.add('show');renderUniverseCloudStatus()};
})(window);

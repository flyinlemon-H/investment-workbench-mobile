...
const stock=plans=>({id:'fixture',code:'600000.SS',name:'兼容性测试',type:'holding',managementCategory:'candidate',shares:0,avgCost:0,currentPrice:34,capPct:12,plans});
async function runtime(plans=[]){
  ...
  for(const file of ['src/management-category.js','src/management-category-ui.js','src/symbol-identity.js','src/strict-ai-json.js','src/plan-v2.js','src/plan-review.js','src/batch-technical-review.js','src/state.js','src/import-export.js','src/position.js','src/rebalance.js','src/v13-plan-engine.js','src/v13-recommendation-engine.js','src/ui-render.js','src/operation-entry.js','src/plan-update-draft.js','src/plan-review-ui.js','src/storage/storage-errors.js','src/storage/storage-validation.js','src/storage/draft-adapter.js','src/storage/storage-manager.js'])vm.runInContext(read(file),context,{filename:file});
  let persisted=null;

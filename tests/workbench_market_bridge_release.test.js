...
test('Shared Strict AI JSON Reliability Fix 3 cache-busts the bridge and Workbench modules',()=>{
  const html=read('index.html');
  const version='shared-strict-ai-json-import-reliability-fix3-20260901';
